"""Exact whole-line variance validation used by the final-stage and screen studies (Section 3.4)."""
...
from studies.paired_solver_prototype import advance_pair, setup, PAR, PK, COUPLINGS

OUT = ROOT / 'output/whole_line_variance_validation'
SEEDS, KEY = 64, 505
...
def main(seeds=SEEDS):
    ...
    (OUT / 'validation.json').write_text(json.dumps(dict(
        ...
        coupler_sha=hashlib.sha256((ROOT/'studies/paired_solver_prototype.py').read_bytes()).hexdigest()[:16],
