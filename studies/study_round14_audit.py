"""Round-14: statistical repair, reproducibility audit, and deterministic fixtures.

No solver batch is run. Items 1-3 of the round-14 request.
"""
import json
import os
import subprocess
...
OUT = ROOT / 'output/round14_audit_2026_09_10'
VAL = ROOT / 'output/round13_validation_2026_09_10/validation.json'
...
def fixtures():
    ...
    prod = advance_rbgbmc_particles(x0, m0, ul, nu, a_rel, h, K,
