"""Build the five paper figures from the archived runs. The particle state for Figure 1 is generated by the same stepper the paper describes and stored in fig1_state.npz."""
